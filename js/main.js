...
(function () {
  ...
  const I18N = {
    ...
    "artists.lead":     { it: "Tre mani, tre linguaggi. Scegli il tuo artista e guarda i suoi lavori.", en: "Three hands, three languages. Choose your artist and see their work.", de: "Drei Hände, drei Sprachen. Wähle deinen Künstler und sieh dir seine Arbeiten an.", fr: "Trois mains, trois langages. Choisis ton artiste et découvre ses œuvres." },
    ...
    "map.consent.text": { it: "Caricando la mappa accetti la trasmissione dei tuoi dati (incluso l'indirizzo IP) a Google Maps, secondo la privacy policy di Google.", en: "By loading the map you agree to the transfer of your data (including your IP address) to Google Maps, in accordance with Google's privacy policy.", de: "Durch das Laden der Karte stimmst du der Übermittlung deiner Daten (einschliesslich deiner IP-Adresse) an Google Maps gemäss der Datenschutzerklärung von Google zu.", fr: "En chargeant la carte, tu acceptes la transmission de tes données (y compris ton adresse IP) à Google Maps, conformément à la politique de confidentialité de Google." },
    "map.consent.btn":  { it: "Carica la mappa", en: "Load the map", de: "Karte laden", fr: "Charger la carte" },
    "map.consent.more": { it: "Maggiori informazioni", en: "Learn more", de: "Mehr erfahren", fr: "En savoir plus" },

    "footer.credit":    { it: "Sviluppato da", en: "Developed by", de: "Entwickelt von", fr: "Développé par" },
    "footer.privacy":   { it: "Privacy Policy", en: "Privacy Policy", de: "Datenschutz", fr: "Confidentialité" },

    /* -------- Privacy Policy page -------- */
    "pp.back":          { it: "← Torna al sito", en: "← Back to site", de: "← Zurück zur Website", fr: "← Retour au site" },
    "pp.tag":           { it: "informativa sulla privacy", en: "privacy notice", de: "datenschutzerklärung", fr: "politique de confidentialité" },
    "pp.title":         { it: "Privacy Policy", en: "Privacy Policy", de: "Datenschutz", fr: "Confidentialité" },
    "pp.updated":       { it: "Ultimo aggiornamento: luglio 2026", en: "Last updated: July 2026", de: "Letzte Aktualisierung: Juli 2026", fr: "Dernière mise à jour : juillet 2026" },
    "pp.intro.text":    { it: "La presente informativa descrive come Keyo Tattoo Studio raccoglie e tratta i dati personali degli utenti che visitano questo sito e utilizzano i moduli di contatto e iscrizione. Trattiamo i dati nel rispetto della Legge federale svizzera sulla protezione dei dati (nLPD) e, ove applicabile, del Regolamento europeo (GDPR).", en: "This notice describes how Keyo Tattoo Studio collects and processes the personal data of users who visit this website and use the contact and enrolment forms. We process data in accordance with the Swiss Federal Act on Data Protection (nFADP) and, where applicable, the European Regulation (GDPR).", de: "Diese Erklärung beschreibt, wie Keyo Tattoo Studio die personenbezogenen Daten der Nutzer erhebt und verarbeitet, die diese Website besuchen und die Kontakt- und Anmeldeformulare nutzen. Wir verarbeiten Daten gemäss dem Schweizer Datenschutzgesetz (revDSG) und, sofern anwendbar, der europäischen Verordnung (DSGVO).", fr: "La présente politique décrit comment Keyo Tattoo Studio collecte et traite les données personnelles des utilisateurs qui visitent ce site et utilisent les formulaires de contact et d'inscription. Nous traitons les données conformément à la loi fédérale suisse sur la protection des données (nLPD) et, le cas échéant, au règlement européen (RGPD)." },
    "pp.controller.title": { it: "Titolare del trattamento", en: "Data controller", de: "Verantwortlicher", fr: "Responsable du traitement" },
    "pp.controller.text": { it: "Keyo Tattoo Studio<br/>Via Al Castello 1, 6600 Locarno, Svizzera<br/>Email: <a href=\"mailto:info@keyotattoostudio.ch\">info@keyotattoostudio.ch</a><br/>Telefono: +41 79 249 08 58", en: "Keyo Tattoo Studio<br/>Via Al Castello 1, 6600 Locarno, Switzerland<br/>Email: <a href=\"mailto:info@keyotattoostudio.ch\">info@keyotattoostudio.ch</a><br/>Phone: +41 79 249 08 58", de: "Keyo Tattoo Studio<br/>Via Al Castello 1, 6600 Locarno, Schweiz<br/>E-Mail: <a href=\"mailto:info@keyotattoostudio.ch\">info@keyotattoostudio.ch</a><br/>Telefon: +41 79 249 08 58", fr: "Keyo Tattoo Studio<br/>Via Al Castello 1, 6600 Locarno, Suisse<br/>Email : <a href=\"mailto:info@keyotattoostudio.ch\">info@keyotattoostudio.ch</a><br/>Téléphone : +41 79 249 08 58" },
    "pp.data.title":    { it: "Dati che raccogliamo", en: "Data we collect", de: "Welche Daten wir erheben", fr: "Données que nous collectons" },
    "pp.data.text":     { it: "Raccogliamo unicamente i dati che ci fornisci volontariamente tramite i moduli del sito: nome e cognome, indirizzo email, numero di telefono, livello di esperienza e il contenuto del messaggio o della motivazione. Non raccogliamo dati sensibili né effettuiamo profilazione automatizzata.", en: "We only collect the data you voluntarily provide through the site's forms: first and last name, email address, phone number, level of experience and the content of your message or motivation. We do not collect sensitive data nor carry out automated profiling.", de: "Wir erheben ausschliesslich die Daten, die du uns freiwillig über die Formulare der Website mitteilst: Vor- und Nachname, E-Mail-Adresse, Telefonnummer, Erfahrungsniveau sowie den Inhalt deiner Nachricht oder Motivation. Wir erheben keine besonderen Daten und führen kein automatisiertes Profiling durch.", fr: "Nous ne collectons que les données que tu nous fournis volontairement via les formulaires du site : nom et prénom, adresse email, numéro de téléphone, niveau d'expérience et le contenu de ton message ou de ta motivation. Nous ne collectons pas de données sensibles et n'effectuons aucun profilage automatisé." },
    "pp.purpose.title": { it: "Finalità del trattamento", en: "Purpose of processing", de: "Zweck der Verarbeitung", fr: "Finalité du traitement" },
    "pp.purpose.text":  { it: "Utilizziamo i tuoi dati esclusivamente per rispondere alle richieste di contatto, gestire le richieste di appuntamento e le iscrizioni alla Keyo Academy, e per comunicarti le informazioni necessarie relative ai nostri servizi. I dati non vengono utilizzati per finalità di marketing senza il tuo consenso.", en: "We use your data exclusively to respond to contact requests, manage appointment requests and Keyo Academy enrolments, and to send you the information necessary about our services. Data is not used for marketing purposes without your consent.", de: "Wir verwenden deine Daten ausschliesslich, um Kontaktanfragen zu beantworten, Terminanfragen und Anmeldungen zur Keyo Academy zu bearbeiten und dir die notwendigen Informationen zu unseren Dienstleistungen zukommen zu lassen. Die Daten werden ohne deine Einwilligung nicht für Marketingzwecke verwendet.", fr: "Nous utilisons tes données exclusivement pour répondre aux demandes de contact, gérer les demandes de rendez-vous et les inscriptions à la Keyo Academy, et pour te transmettre les informations nécessaires sur nos services. Les données ne sont pas utilisées à des fins marketing sans ton consentement." },
    "pp.legal.title":   { it: "Base giuridica", en: "Legal basis", de: "Rechtsgrundlage", fr: "Base légale" },
    "pp.legal.text":    { it: "Il trattamento si fonda sul tuo consenso, prestato al momento dell'invio del modulo, e sull'esecuzione delle misure precontrattuali e contrattuali richieste (ad esempio la gestione di un appuntamento o di un'iscrizione).", en: "Processing is based on your consent, given when you submit the form, and on the performance of the pre-contractual and contractual measures you request (for example handling an appointment or an enrolment).", de: "Die Verarbeitung beruht auf deiner Einwilligung, die du bei der Übermittlung des Formulars erteilst, sowie auf der Durchführung der von dir angeforderten vorvertraglichen und vertraglichen Massnahmen (z. B. die Bearbeitung eines Termins oder einer Anmeldung).", fr: "Le traitement repose sur ton consentement, donné lors de l'envoi du formulaire, et sur l'exécution des mesures précontractuelles et contractuelles demandées (par exemple la gestion d'un rendez-vous ou d'une inscription)." },
    "pp.retention.title": { it: "Conservazione dei dati", en: "Data retention", de: "Aufbewahrung der Daten", fr: "Conservation des données" },
    "pp.retention.text": { it: "Conserviamo i dati personali solo per il tempo necessario a gestire la tua richiesta e adempiere agli obblighi di legge. Trascorso tale periodo, i dati vengono cancellati o resi anonimi.", en: "We retain personal data only for as long as necessary to handle your request and comply with legal obligations. After that period, data is deleted or anonymised.", de: "Wir bewahren personenbezogene Daten nur so lange auf, wie es zur Bearbeitung deiner Anfrage und zur Erfüllung gesetzlicher Pflichten erforderlich ist. Nach Ablauf dieses Zeitraums werden die Daten gelöscht oder anonymisiert.", fr: "Nous conservons les données personnelles uniquement pendant la durée nécessaire au traitement de ta demande et au respect des obligations légales. Passé ce délai, les données sont supprimées ou anonymisées." },
    "pp.sharing.title": { it: "Condivisione con terzi", en: "Sharing with third parties", de: "Weitergabe an Dritte", fr: "Partage avec des tiers" },
    "pp.sharing.text":  { it: "I moduli del sito sono gestiti tramite il servizio Formspree, che elabora l'invio delle email per nostro conto in qualità di responsabile del trattamento. Non vendiamo né cediamo i tuoi dati a terzi per finalità commerciali. Alcuni fornitori possono trattare i dati al di fuori della Svizzera o dello Spazio Economico Europeo, sempre nel rispetto di adeguate garanzie.", en: "The site's forms are handled through the Formspree service, which processes email delivery on our behalf as a data processor. We do not sell or transfer your data to third parties for commercial purposes. Some providers may process data outside Switzerland or the European Economic Area, always subject to appropriate safeguards.", de: "Die Formulare der Website werden über den Dienst Formspree abgewickelt, der die E-Mail-Zustellung in unserem Auftrag als Auftragsverarbeiter durchführt. Wir verkaufen oder übermitteln deine Daten nicht zu kommerziellen Zwecken an Dritte. Einige Anbieter können Daten ausserhalb der Schweiz oder des Europäischen Wirtschaftsraums verarbeiten, stets unter Einhaltung angemessener Garantien.", fr: "Les formulaires du site sont gérés via le service Formspree, qui traite l'envoi des emails pour notre compte en tant que sous-traitant. Nous ne vendons ni ne cédons tes données à des tiers à des fins commerciales. Certains prestataires peuvent traiter les données en dehors de la Suisse ou de l'Espace économique européen, toujours dans le respect de garanties appropriées." },
    "pp.rights.title":  { it: "I tuoi diritti", en: "Your rights", de: "Deine Rechte", fr: "Tes droits" },
    "pp.rights.text":   { it: "Hai il diritto di accedere ai tuoi dati, chiederne la rettifica o la cancellazione, limitarne o opporti al trattamento e revocare il consenso in qualsiasi momento. Per esercitare questi diritti scrivici a <a href=\"mailto:info@keyotattoostudio.ch\">info@keyotattoostudio.ch</a>. Hai inoltre il diritto di presentare un reclamo all'autorità di controllo competente (in Svizzera: l'Incaricato federale della protezione dei dati e della trasparenza, IFPDT).", en: "You have the right to access your data, request its rectification or erasure, restrict or object to its processing and withdraw your consent at any time. To exercise these rights, write to us at <a href=\"mailto:info@keyotattoostudio.ch\">info@keyotattoostudio.ch</a>. You also have the right to lodge a complaint with the competent supervisory authority (in Switzerland: the Federal Data Protection and Information Commissioner, FDPIC).", de: "Du hast das Recht, auf deine Daten zuzugreifen, deren Berichtigung oder Löschung zu verlangen, die Verarbeitung einzuschränken oder ihr zu widersprechen und deine Einwilligung jederzeit zu widerrufen. Um diese Rechte auszuüben, schreibe uns an <a href=\"mailto:info@keyotattoostudio.ch\">info@keyotattoostudio.ch</a>. Du hast zudem das Recht, bei der zuständigen Aufsichtsbehörde Beschwerde einzureichen (in der Schweiz: der Eidgenössische Datenschutz- und Öffentlichkeitsbeauftragte, EDÖB).", fr: "Tu as le droit d'accéder à tes données, d'en demander la rectification ou l'effacement, d'en limiter ou de t'opposer au traitement et de retirer ton consentement à tout moment. Pour exercer ces droits, écris-nous à <a href=\"mailto:info@keyotattoostudio.ch\">info@keyotattoostudio.ch</a>. Tu as également le droit d'introduire une réclamation auprès de l'autorité de contrôle compétente (en Suisse : le Préposé fédéral à la protection des données et à la transparence, PFPDT)." },
    "pp.cookies.title": { it: "Cookie e tecnologie di tracciamento", en: "Cookies and tracking technologies", de: "Cookies und Tracking-Technologien", fr: "Cookies et technologies de suivi" },
    "pp.cookies.text":  { it: "Questo sito non utilizza cookie di profilazione né strumenti di tracciamento pubblicitario o di analisi. Utilizziamo esclusivamente un archivio locale del browser (localStorage) per ricordare la lingua da te selezionata: si tratta di un dato tecnico che rimane sul tuo dispositivo e non viene trasmesso a terzi.", en: "This site does not use profiling cookies or any advertising or analytics tracking tools. We only use the browser's local storage (localStorage) to remember the language you selected: this is a technical piece of data that stays on your device and is not shared with third parties.", de: "Diese Website verwendet keine Profiling-Cookies und keine Werbe- oder Analyse-Tracking-Tools. Wir nutzen ausschliesslich den lokalen Speicher des Browsers (localStorage), um die von dir gewählte Sprache zu speichern: Dabei handelt es sich um eine technische Angabe, die auf deinem Gerät verbleibt und nicht an Dritte weitergegeben wird.", fr: "Ce site n'utilise pas de cookies de profilage ni d'outils de suivi publicitaire ou d'analyse. Nous utilisons uniquement le stockage local du navigateur (localStorage) pour mémoriser la langue que tu as choisie : il s'agit d'une donnée technique qui reste sur ton appareil et n'est pas transmise à des tiers." },
    "pp.maps.title":    { it: "Mappa e Google Maps", en: "Map and Google Maps", de: "Karte und Google Maps", fr: "Carte et Google Maps" },
    "pp.maps.text":     { it: "Nella pagina dei contatti mostriamo la nostra posizione tramite Google Maps. Per tutelare la tua privacy, la mappa non viene caricata automaticamente: appare un segnaposto e la mappa viene mostrata solo dopo che clicchi sul pulsante di consenso. Al momento del caricamento, Google potrebbe raccogliere dati come il tuo indirizzo IP e utilizzare cookie propri; il trattamento è soggetto alla privacy policy di Google. Finché non presti il consenso, nessun dato viene trasmesso a Google.", en: "On the contact page we show our location via Google Maps. To protect your privacy, the map is not loaded automatically: a placeholder is shown and the map only appears after you click the consent button. When loaded, Google may collect data such as your IP address and use its own cookies; this processing is subject to Google's privacy policy. Until you give consent, no data is transmitted to Google.", de: "Auf der Kontaktseite zeigen wir unseren Standort über Google Maps. Zum Schutz deiner Privatsphäre wird die Karte nicht automatisch geladen: Es wird ein Platzhalter angezeigt und die Karte erscheint erst, nachdem du auf die Zustimmungsschaltfläche geklickt hast. Beim Laden kann Google Daten wie deine IP-Adresse erheben und eigene Cookies verwenden; diese Verarbeitung unterliegt der Datenschutzerklärung von Google. Solange du nicht zustimmst, werden keine Daten an Google übermittelt.", fr: "Sur la page de contact, nous affichons notre emplacement via Google Maps. Pour protéger ta vie privée, la carte n'est pas chargée automatiquement : un espace réservé s'affiche et la carte n'apparaît qu'après que tu aies cliqué sur le bouton de consentement. Lors du chargement, Google peut collecter des données telles que ton adresse IP et utiliser ses propres cookies ; ce traitement est soumis à la politique de confidentialité de Google. Tant que tu ne donnes pas ton consentement, aucune donnée n'est transmise à Google." },
    "pp.changes.title": { it: "Modifiche a questa informativa", en: "Changes to this notice", de: "Änderungen dieser Erklärung", fr: "Modifications de cette politique" },
    "pp.changes.text":  { it: "Ci riserviamo il diritto di aggiornare la presente informativa. Eventuali modifiche saranno pubblicate su questa pagina con la relativa data di aggiornamento.", en: "We reserve the right to update this notice. Any changes will be published on this page together with the relevant update date.", de: "Wir behalten uns das Recht vor, diese Erklärung zu aktualisieren. Etwaige Änderungen werden auf dieser Seite mit dem entsprechenden Aktualisierungsdatum veröffentlicht.", fr: "Nous nous réservons le droit de mettre à jour cette politique. Toute modification sera publiée sur cette page avec la date de mise à jour correspondante." },
    "pp.contact.title": { it: "Contatti", en: "Contact", de: "Kontakt", fr: "Contact" },
    "pp.contact.text":  { it: "Per qualsiasi domanda relativa a questa informativa o al trattamento dei tuoi dati, contattaci a <a href=\"mailto:info@keyotattoostudio.ch\">info@keyotattoostudio.ch</a>.", en: "For any questions regarding this notice or the processing of your data, contact us at <a href=\"mailto:info@keyotattoostudio.ch\">info@keyotattoostudio.ch</a>.", de: "Bei Fragen zu dieser Erklärung oder zur Verarbeitung deiner Daten kontaktiere uns unter <a href=\"mailto:info@keyotattoostudio.ch\">info@keyotattoostudio.ch</a>.", fr: "Pour toute question concernant cette politique ou le traitement de tes données, contacte-nous à <a href=\"mailto:info@keyotattoostudio.ch\">info@keyotattoostudio.ch</a>." },
  ...
  /* -------- Google Maps: click-to-load (privacy consent) -------- */
  (function () {
    ...
    btn.addEventListener("click", function () {
      ...
      iframe.src = src;
      iframe.title = "Keyo Tattoo Studio — Via al Castello 1, 6600 Locarno";
      iframe.loading = "lazy";
